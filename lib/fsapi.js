...
FSApi.prototype.tree = function (id) {
  ...
  return this.get('/familytree/v2/pedigree/' + id, { query:{properties:"all", ancestors:4, 'sessionId':this.sessionId, 'dataFormat':"application/json"}, headers:{ 'Accept':'application/json', 'User-Agent':'fsapi for node.js', 'Cookie':"fssessionid=" + this.sessionId} },
